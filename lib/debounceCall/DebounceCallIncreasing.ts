...
/**
 * Call only the LAST callback of specified id. Each call of "invoke" will
 * increase the timer.
 *
 * Call invoke method on each change. Only the last time will be fulfilled. It
 * returns a promise which will be fulfilled at the end of full cycle.
 */
