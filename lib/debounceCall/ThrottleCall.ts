...
/**
 * Call only the first callback of specified id and refuse other calls while
 * timeout is in progress. If cb was called with error the timeout will be
 * started any way. If debounceMs isn't set then current timeout will be
 * cleared
 */
